...
<html>
	...
	<body>
		<a href="#create-property" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-property" class="content scaffold-create" role="main">
			<h1><g:message code="property.uploadImage.label"/></h1>
			...
			<g:uploadForm controller="property" action="save" method="post" enctype="multipart/form-data">
				<fieldset class="form">
